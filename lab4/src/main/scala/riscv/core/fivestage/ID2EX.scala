...
class ID2EX extends Module {
  ...
  regs_reg1_read_address.io.stall := io.stall
  ...
  regs_reg2_read_address.io.stall := io.stall
  ...
  regs_write_enable.io.stall := io.stall
  ...
  regs_write_address.io.stall := io.stall
  ...
  regs_write_source.io.stall := io.stall
  ...
  aluop1_source.io.stall := io.stall
  ...
  aluop2_source.io.stall := io.stall
  ...
  csr_write_enable.io.stall := io.stall
  ...
  memory_read_enable.io.stall := io.stall
  ...
  memory_write_enable.io.stall := io.stall
  ...
  csr_read_data.io.stall := io.stall
